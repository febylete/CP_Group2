...
#1) make sure assumptions are listed and explained currently
#2)clevenes'
#3) final commit + send minh email of pdf
#4) she will email sejin
...
Another assumption that had to be checked was the homogeneity of variance. Levene's Test was performed to verify that this assumption holds true across the four feed conditions and the two valence conditions.
...
##shareworthiness...
leveneTest(share_all~Feed,data=Data_EN)
leveneTest(share_all~Feed,data=Data_CN)
leveneTest(share_all~Feed,data=Data)


##creditworthiness...
leveneTest(credavg_all~Feed,data=Data_EN)
leveneTest(credavg_all~Feed,data=Data_CN)
leveneTest(credavg_all~Feed,data=Data)
...
#newsworthiness
leveneTest(nwavg_all~valence,data=Data_EN)
leveneTest(nwavg_all~valence,data=Data_CN)
leveneTest(nwavg_all~valence,data=Data)

##shareworthiness...
leveneTest(share_all~valence,data=Data_EN)
leveneTest(share_all~valence,data=Data_CN)
leveneTest(share_all~valence,data=Data)

##creditworthiness...
leveneTest(credavg_all~valence,data=Data_EN)
leveneTest(credavg_all~valence,data=Data_CN)
leveneTest(credavg_all~valence,data=Data)
...
The assumptions for the tests utilized were not met in all cases. Assumptions of normality for the outcomes of interest were not met. This means that alternative tests are required for some of the hypothesis testing and to answer the research questions appropriately. An additional problem identified was that 
