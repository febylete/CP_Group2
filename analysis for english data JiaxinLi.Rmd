...
```{r}
library(car)
leveneTest(credavg_all ~ feed_type, data = english_data_filtered)
```
...
```{r}
library(car)
leveneTest(nwavg_all ~ feed_type, data = english_data_filtered)
...
```{r}
library(car)
ancova_model_credibility <- aov(credavg_all ~ feed_type + NewsSharing_SM + NewsCred_SMÂ., data = english_data_filtered)
...
```{r}
library(car)
ancova_model_newsworthiness <- aov(nwavg_all ~ feed_type + NewsSharing_SM + NewsCred_SMÂ., data = english_data_filtered)
